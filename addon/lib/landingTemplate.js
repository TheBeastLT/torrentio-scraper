              ...
              <div class="pt-2 border-t border-gray-800/50">
                  ...
                  <div class="flex justify-center gap-4">
                      ...
                      <button 
                          ...
                          <svg class="w-4 h-4 md:w-5 md:h-5 text-gray-400 group-hover:text-teal-400" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M3.633 2.964c-.756 0-1.229.818-.852 1.472l2.684 4.65c.377.653 1.07 1.057 1.824 1.057h13.08c.755 0 1.228-.818.852-1.472l-2.685-4.65c-.376-.654-1.07-1.057-1.823-1.057H3.633zm16.734 8.018c.755 0 1.228.818.852 1.472l-2.685 4.65c-.376.654-1.07 1.057-1.823 1.057H3.632c-.755 0-1.228-.818-.852-1.472l2.685-4.65c.376-.654 1.07-1.057 1.823-1.057h13.079zm-16.734 8.018c-.756 0-1.229.819-.852 1.473l2.684 4.65c.377.653 1.07 1.057 1.824 1.057h13.08c.755 0 1.228-.819.852-1.473l-2.685-4.65c-.376-.654-1.07-1.057-1.823-1.057H3.633z"/></svg>
                          <div 
